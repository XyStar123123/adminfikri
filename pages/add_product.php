        ...
        <div class="content-section">
            ...
            <div class="form-container">
                ...
                <form action="../actions/products/add_product.php" class="form" method="POST">
                    <div class="form-group">
                        <label class="form-label">Name</label>
                        <input type="text" name="name" class="form-input" placeholder="Enter product name eg. Samsung S24" required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-input" placeholder="Enter product price eg. 2300" name="price" required>
                    </div>
                    <div class="form-group">
                        <label class="form-label">Stock</label>
                        <input type="text" class="form-input" placeholder="Enter product warehouse stock eg. 300" name="stock" required>
                    </div>
                    <div class="form-group">
